...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`min-h-[65svh] sm:min-h-screen w-full relative overflow-hidden bg-black ${className}`}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pt-16 sm:pt-0 text-white">
        {/* Trust Badge */}
        {trustBadge && (
          <div className="mb-4 sm:mb-8 animate-fade-in-down">
            <div className="flex items-center gap-2 px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full text-sm">
              ...
              <span className="text-xs sm:text-sm text-white/90 font-medium tracking-wide">{trustBadge.text}</span>
            </div>
          </div>
        )}
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4 mt-6 sm:mt-0">
          ...
          <div className="space-y-4">
            <h1
              className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-extrabold pb-2 animate-fade-in-up animation-delay-200 drop-shadow-[0_0_20px_rgba(0,0,0,0.8)]"
              style={{
            ...
            <h1 className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight animate-fade-in-up animation-delay-400 drop-shadow-xl shadow-black">
              {headline.line2}
            </h1>
          </div>

...
export function SplineHero() {
  ...
  return (
    <div className="relative w-full min-h-0 md:min-h-screen bg-black overflow-hidden flex flex-col items-center justify-start md:justify-center pt-24 md:pt-0 pb-8 md:pb-0 px-4 md:px-0">

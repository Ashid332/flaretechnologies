    ...
    return (
        <section id="methodology" className="process-section section-padding" ref={sectionRef}>
                ...
                <div className="horizontal-timeline scroll-anim slide-up">
                    <PixelCard colors="#ef4444,#f97316,#ffedd5" className="timeline-node" gap={10} speed={1} noFocus={false}>
                    ...
                    <PixelCard colors="#f59e0b,#fbbf24,#fff7ed" className="timeline-node" gap={10} speed={1} noFocus={false}>
                    ...
                    <PixelCard colors="#0ea5e9,#38bdf8,#f0f9ff" className="timeline-node" gap={10} speed={1} noFocus={false}>
                    ...
                    <PixelCard colors="#a855f7,#c084fc,#faf5ff" className="timeline-node" gap={10} speed={1} noFocus={false}>
